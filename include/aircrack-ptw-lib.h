...
int32_t PTW_addsession(PTW_attackstate *, uint8_t *, uint8_t *, int32_t *, int32_t);
int32_t PTW_computeKey(
	PTW_attackstate *, uint8_t *, int32_t, int32_t, int32_t *, int32_t[][PTW_n], int32_t attacks);
